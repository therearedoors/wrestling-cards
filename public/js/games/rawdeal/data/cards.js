...
window.RawDeal.CARDS = {
  ...
  'trip': {
    ...
    fortitude: 6,
    damage: 0,
    text: "Reversal: Strike/Grapple/High Risk: Special    (TAG TEAM ONLY SYMBOL) If played from your hand and if you are an “inactive” player of your team; reverses any Strike, Grapple, or High Risk maneuver and end your opponent’s turn. Play proceeds with your partner’s turn.",
    flavor: "",
    hybrid: true,
    reverses: ["strike"],
    set: "premiere",
