...
window.RawDeal.CARDS = {
  ...
  'drop-kick': {
    ...
    flavor: "",
    hybrid: true,
    reversesOnlyManeuver: "drop-kick",
    reversalEffects: [{"op": "dealDamage"}],
    set: "premiere",
  },
  'discus-punch': {
  ...
  'chair-shot': {
    ...
    fortitude: 10,
    damage: 10,
    text: "Strike: Foreign Object / SV: 1",
    flavor: "",
    set: "premiere",
  },
  'hurricanrana': {
  ...
  'belly-to-belly-suplex': {
    ...
    flavor: "",
    hybrid: true,
    reversesOnlyManeuver: "belly-to-belly-suplex",
    reversalEffects: [{"op": "dealDamage"}],
    set: "premiere",
  },
  'atomic-facebuster': {
  ...
  'vertical-suplex': {
    ...
    flavor: "",
    hybrid: true,
    reversesOnlyManeuver: "vertical-suplex",
    reversalEffects: [{"op": "dealDamage"}],
    set: "premiere",
  },
  'belly-to-back-suplex': {
    ...
    flavor: "",
    hybrid: true,
    reversesOnlyManeuver: "belly-to-back-suplex",
    reversalEffects: [{"op": "dealDamage"}],
    set: "premiere",
  },
  'pump-handle-slam': {
  ...
  'clean-break': {
    ...
    reversalEffects: [{"op": "opponentDiscardFromHand", "count": 4}, {"op": "draw", "count": 1}],
    set: "premiere",
  },
  'manager-interferes': {
    ...
    reversalEffects: [{"op": "dealDamage"}, {"op": "draw", "count": 1}],
    set: "premiere",
  },
  'disqualification': {
    id: "disqualification",
    ...
    fortitude: 10,
    damage: 0,
    text: "Reversal: Special Reverse any HEEL maneuver or reversal card if that opponent has 5 or more HEEL cards in his Ring area. Opponent is Disqualified and you win the game. This effect happens even if the card titled Disqualification is placed into your Ringside pile while applying damage from a HEEL maneuver or reversal card.",
    flavor: "",
    reverses: ["heel"],
    requiresOpponentHeelInRing: 5,
    disqualifiesOpponent: true,
    set: "premiere",
  },
  'no-chance-in-hell': {
  ...
  'shake-it-off': {
    ...
    flavor: "",
    requiresLowerFortitudeThanOpponent: true,
    actionEffects: [{"op": "removeOpponentRingCard"}],
    set: "premiere",
  },
  'offer-handshake': {
    id: "offer-handshake",
  ...
  'spit-at-opponent': {
    ...
    fortitude: 4,
    damage: 0,
    text: "Action You discard 1 card. Your opponent discards 4 cards.",
    flavor: "",
    actionEffects: [{"op": "discardFromHand", "count": 1}, {"op": "opponentDiscardFromHand", "count": 4}],
    set: "premiere",
  },
  'get-crowd-support': {
  ...
  'shane-omac': {
    ...
    flavor: "",
    preDrawRingEffects: [{"op": "opponentTopArsenalToRingside", "count": 1}],
    set: "premiere",
  },
  'maintain-hold': {
    id: "maintain-hold",
  ...
  'chyna-interferes': {
    ...
    flavor: "",
    reverses: ["strike", "grapple", "submission", "high-risk", "trademark", "trademark-finisher"],
    reversalEffects: [{"op": "dealDamage"}, {"op": "draw", "count": 2}],
    set: "premiere",
  },
  'peoples-eyebrow': {
    id: "peoples-eyebrow",
  ...
  'rock-bottom': {
    ...
    unique: true,
    hybrid: true,
    maneuverEffects: [{"op": "searchArsenalOrRingsideForCard", "cardId": "peoples-elbow"}],
    reversesOnlySubtype: "grapple",
    requiresReversalDiscard: 1,
    reversalEffects: [{"op": "dealDamage"}],
    set: "premiere",
  },
  'kane': {
